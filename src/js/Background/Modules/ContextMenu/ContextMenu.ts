...
export default class ContextMenu {
  private static readonly queryLinks: Record<
    ContextMenuKeys,
    [string, string, () => boolean]
  > = {
    context_steam_store: [
      __options_contextSteamStore,
      "https://store.steampowered.com/search/?term=__query__",
      () => Settings.context_steam_store,
    ],
    context_steam_lucky: [
      __options_contextSteamLucky,
      "https://store.steampowered.com/search/?term=__query__&ifeellucky",
      () => Settings.context_steam_lucky,
    ],
    context_steam_market: [
      __options_contextSteamMarket,
      "https://steamcommunity.com/market/search?q=__query__",
      () => Settings.context_steam_market,
    ],
    context_itad: [
      __options_contextItad,
      "https://isthereanydeal.com/search/?q=__query__",
      () => Settings.context_itad,
    ],
    context_bartervg: [
      __options_contextBartervg,
      "https://barter.vg/search?q=__query__",
      () => Settings.context_bartervg,
    ],
    context_steamdb: [
      __options_contextSteamdb,
      "https://steamdb.info/search/?q=__query__",
      () => Settings.context_steamdb,
    ],
    context_steamdb_instant: [
      __options_contextSteamdbInstant,
      "https://steamdb.info/instantsearch/?query=__query__",
      () => Settings.context_steamdb_instant,
    ],
    context_protondb: [
      __options_contextProtondb,
      "https://www.protondb.com/search?q=__query__",
      () => Settings.context_protondb,
    ],
    context_steam_keys: [
      __options_contextSteamKeys,
      "https://store.steampowered.com/account/registerkey?key=__query__",
