...
export class SettingsStore {
  ...
  private static storage: StorageInterface<SettingsSchema> =
    new SyncedStorage<SettingsSchema>();
  ...
  static async set<K extends SchemaKeys<SettingsSchema>>(
    key: K,
    value: SchemaValue<SettingsSchema, K>,
  ): Promise<void> {
  ...
  static clear(): void {
    this.storage.remove(
      ...(Object.keys(this.data) as SchemaKeys<SettingsSchema>[]),
    );
...
export default new Proxy(SettingsStore, {
  get<K extends SchemaKeys<SettingsSchema>>(
    target: typeof SettingsStore,
    prop: K,
  ): SchemaValue<SettingsSchema, K> {
    return target.get(prop);
  },

  set<K extends SchemaKeys<SettingsSchema>>(
    target: typeof SettingsStore,
    prop: K,
    value: SchemaValue<SettingsSchema, K>,
  ): boolean {
